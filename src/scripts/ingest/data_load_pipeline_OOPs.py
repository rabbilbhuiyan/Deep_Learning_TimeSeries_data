...
# +
# Data pipeline using OOPs concept
...
def combine_and_save_data(data_dir, cache_dir):
    ...
    dataset = os.path.join(cache_dir, 'moving-site-dataset.csv') # change the file name accordingly
...
#rename_file(DATA_DIR_SS)
#rename_file(DATA_DIR_MS)

#combine_and_save_data(DATA_DIR_SS, CACHE_DIR_SS)
#combine_and_save_data(DATA_DIR_MS, CACHE_DIR_MS)
# -
